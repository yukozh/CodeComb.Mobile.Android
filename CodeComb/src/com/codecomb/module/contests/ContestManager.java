...
public class ContestManager {
	...
	public List<Contest> getManagedContest() {

		List<Contest> contests = new ArrayList<Contest>();

		try {
			contests = contestService.getManagedContests(context, accessToken);
	...
	public List<Contest> getManagedContest(int page) {

		List<Contest> contests = new ArrayList<Contest>();

		try {
			contests = contestService.getManagedContests(context, accessToken,page);
