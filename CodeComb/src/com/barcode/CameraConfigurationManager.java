...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		Log.e("CAM", "----------initFromCameraParameters-------");
	...
	void setDesiredCameraParameters(Camera camera) {
		...
		Log.e("CAM", "----------setDesiredCameraParameters-------");
		...
		//angle: landscape is 0,portrait is 90
		
		boolean  isLandcape = ActivityUtil.isScreenOrientationLandscape(context);
		
		int angle = isLandcape ? 0 : 90;
