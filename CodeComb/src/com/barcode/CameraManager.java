...
//		}
	  ...
	  //This can support screen orientation changes at any time
		cameraManager = new CameraManager(context);
	...
	public Rect getFramingRectInPreview() {
		...
		Log.e("CAM", "----------getFramingRectInPreview-------");
		...
		if (framingRectInPreview == null) {
			...
			if(ActivityUtil.isScreenOrientationLandscape(context)){
